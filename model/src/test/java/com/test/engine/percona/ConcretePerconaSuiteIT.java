package com.test.engine.percona;
...
public abstract class ConcretePerconaSuiteIT extends AbstractTestSuite {

    public ConcretePerconaSuiteIT() {
        var property = SpringApp.get("percona");
    ...
    public void checkEngine() {
        Assertions.assertEquals(
            this.injectionModel.getMediatorEngine().getPercona(),
