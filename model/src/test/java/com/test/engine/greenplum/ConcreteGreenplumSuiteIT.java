package com.test.engine.greenplum;
...
public abstract class ConcreteGreenplumSuiteIT extends AbstractTestSuite {

    public ConcreteGreenplumSuiteIT() {
        var property = SpringApp.get("greenplum");
        ...
        this.databaseToInject = "pg_catalog";
        this.tableToInject = "gp_id";
        this.columnToInject = "gpname";
    ...
    public void checkEngine() {
        Assertions.assertEquals(
            this.injectionModel.getMediatorEngine().getGreenplum(),
