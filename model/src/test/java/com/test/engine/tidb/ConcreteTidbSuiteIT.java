...
public abstract class ConcreteTidbSuiteIT extends AbstractTestSuite {

    public ConcreteTidbSuiteIT() {
        var property = SpringApp.get("tidb");
    ...
    public void checkEngine() {
        Assertions.assertEquals(
            this.injectionModel.getMediatorEngine().getTidb(),
